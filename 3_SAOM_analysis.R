...
jpeg(filename='Figure3.jpeg',width=9,height=7,units='in',res=1000)
...
write.table(outcome(siena_models[[1]][c(3,9,15)]),'siena_models1_20.csv',sep=';')
write.table(outcome(siena_models[[2]][c(3,9,15)]),'siena_models2_20.csv',sep=';')
write.table(outcome(siena_models[[3]][c(3,9,15)]),'siena_models3_20.csv',sep=';')
